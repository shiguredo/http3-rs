...
pub const NGHTTP3_VERSION: &[u8; 8] = b"1.17.90\0";
pub const NGHTTP3_VERSION_NUM: u32 = 69978;
...
pub const NGHTTP3_STREAM_CLOSE_FLAG_NONE: u32 = 0;
pub const NGHTTP3_STREAM_CLOSE_FLAG_RX_APP_ERROR_CODE_SET: u32 = 1;
pub const NGHTTP3_STREAM_CLOSE_FLAG_TX_APP_ERROR_CODE_SET: u32 = 2;
pub const NGHTTP3_CALLBACKS_V1: u32 = 1;
pub const NGHTTP3_CALLBACKS_V2: u32 = 2;
pub const NGHTTP3_CALLBACKS_V3: u32 = 3;
pub const NGHTTP3_CALLBACKS_V4: u32 = 4;
pub const NGHTTP3_CALLBACKS_VERSION: u32 = 4;
...
pub type nghttp3_stream_close2 = ::std::option::Option<
    unsafe extern "C" fn(
        conn: *mut nghttp3_conn,
        flags: u32,
        stream_id: i64,
...
pub type nghttp3_recv_wt_close_session = ::std::option::Option<
    unsafe extern "C" fn(
        conn: *mut nghttp3_conn,
        session_id: i64,
        wt_error_code: u32,
...
pub struct nghttp3_callbacks {
    ...
    #[doc = " :member:`recv_wt_close_session` is a callback function which is\n invoked when WT_CLOSE_SESSION Capsule is received."]
    pub recv_wt_close_session: nghttp3_recv_wt_close_session,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of nghttp3_callbacks"][::std::mem::size_of::<nghttp3_callbacks>() - 184usize];
    ...
    ["Offset of field: nghttp3_callbacks::stream_close2"]
        [::std::mem::offset_of!(nghttp3_callbacks, stream_close2) - 152usize];
    ["Offset of field: nghttp3_callbacks::recv_wt_data"]
        [::std::mem::offset_of!(nghttp3_callbacks, recv_wt_data) - 160usize];
    ["Offset of field: nghttp3_callbacks::wt_data_stream_open"]
        [::std::mem::offset_of!(nghttp3_callbacks, wt_data_stream_open) - 168usize];
    ["Offset of field: nghttp3_callbacks::recv_wt_close_session"]
        [::std::mem::offset_of!(nghttp3_callbacks, recv_wt_close_session) - 176usize];
};
unsafe extern "C" {
...
unsafe extern "C" {
    ...
    pub fn nghttp3_conn_close_stream2(
        conn: *mut nghttp3_conn,
        flags: u32,
        stream_id: i64,
        rx_app_error_code: u64,
