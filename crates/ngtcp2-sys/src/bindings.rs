...
pub const NGTCP2_VERSION: &[u8; 7] = b"1.21.0\0";
pub const NGTCP2_VERSION_NUM: u32 = 70912;
...
pub const NGTCP2_SETTINGS_VERSION: u32 = 3;
...
pub const NGTCP2_CALLBACKS_VERSION: u32 = 2;
...
pub struct ngtcp2_conn_info {
    ...
    #[doc = " :member:`pkt_sent` is the number of QUIC packets sent.  This\n field has been available since v1.16.0."]
    pub pkt_sent: u64,
    ...
    pub bytes_lost: u64,
    #[doc = " :member:`ping_recv` is the number of PING frames received.  This\n field has been available since v1.16.0."]
    pub ping_recv: u64,
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ngtcp2_settings"][::std::mem::size_of::<ngtcp2_settings>() - 200usize];
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ngtcp2_callbacks"][::std::mem::size_of::<ngtcp2_callbacks>() - 328usize];
