...
pub const NGTCP2_VERSION: &[u8; 8] = b"1.24.90\0";
pub const NGTCP2_VERSION_NUM: u32 = 71770;
...
pub const NGTCP2_CALLBACKS_VERSION: u32 = 5;
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ngtcp2_callbacks"][::std::mem::size_of::<ngtcp2_callbacks>() - 376usize];
