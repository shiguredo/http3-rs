# shiguredo_ngtcp2 系クライアントに IP SAN 検証と検証失敗理由の診断性を追加する

- Created: 2026-08-08
- Completed: {YYYY-MM-DD}
- Branch: feature/add-shiguredo-ngtcp2-ip-san-verification
- Polished: {YYYY-MM-DD}

## 目的

shiguredo_ngtcp2 系クライアントの証明書検証 (0140 で実装済み) を拡張し、IP アドレス直結サーバーへの検証付き接続を可能にするとともに、検証失敗の理由を利用者に伝えられるようにする。
